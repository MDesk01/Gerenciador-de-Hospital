  ...
  addPatient() {
    ...
    dialogRef.afterClosed().subscribe(data => {
      if(data) {
        ...
        this.openSnackBar("Paciente registrado(a) com Sucesso!", "OK")
      }
    })
  }
  ...
  editPatient(row : any) {
    ...
    dialogRef.afterClosed().subscribe(data => {
      if(data) {
        ...
        this.openSnackBar("Paciente atualizado(a) com sucesso!", "OK")
      }
    })
  }
  ...
  deletePatient(row : any) {
    ...
    dialogRef.afterClosed().subscribe(data => {
      if(data) {
        ...
        this.openSnackBar("Paciente excluído com sucesso!", "OK")
      }
    })
  }
