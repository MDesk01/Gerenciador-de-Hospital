...
export class DoctorComponent implements OnInit {
  ...
  addDoctor() {
    ...
    dialogRef.afterClosed().subscribe(data => {
      if(data) {
        ...
        this.openSnackBar("Registro concluído com sucesso!", "OK")
      }
    })
  }
  ...
  editDoctor(row : any) {
    ...
    dialogConfig.data.title = "Editar Médico(a)";
    dialogConfig.data.buttonName = "Editar";
    ...
    dialogRef.afterClosed().subscribe(data => {
      if(data) {
        ...
        this.openSnackBar("Informações de médico(a) atualizadas!", "OK")
      }
    })
  }
  ...
  deleteDoctor(row : any) {
    ...
    dialogRef.afterClosed().subscribe(data => {
      if(data) {
        ...
        this.openSnackBar("Registro Excluídos com sucesso!", "OK")
      }
    })
  }
